                ...
                @auth
                    @can('create', App\Models\Vacante::class)
                        <a href="{{ route('notificaciones') }}"
                            class="flex items-center justify-center bg-indigo-600 hover:bg-indigo-800 p-1 rounded-full">
                            <p
                                class="w-7 h-7 rounded-full flex flex-col justify-center items-center text-sm text-white font font-extrabold">
