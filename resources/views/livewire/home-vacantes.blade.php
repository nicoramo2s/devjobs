                    ...
                    <div class="md:flex md:justify-between md:items-center py-5 divide-y divide-gray-200">
                        <div class="md:flex-1">
                            ...
                            <p class="font-bold text-xs text-gray-600">
                                Ultimo dia para aplicar: <span class="font-normal">{{$vacante->ultimo_dia->format('d/m/Y')}}</span>
                            </p>
                        </div>

                        <div class="mt-5 md:mt-0">
                            <a href="{{ route('vacantes.show', $vacante->id) }}"
                                class="bg-indigo-500 p-3 text-sm uppercase font-bold rounded-lg text-white hover:bg-indigo-700 block text-center">
                                Ver Vacante
                            </a>
                        </div>
                    </div>
